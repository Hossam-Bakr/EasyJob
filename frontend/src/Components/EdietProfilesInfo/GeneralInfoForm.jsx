...
const GeneralInfoForm = ({ data }) => {
    ...
    // const currentLocationType= data.location.type?data.location.type:"";
    // const currentLocationCoordinates= data.location.coordinates?data.location.coordinates:[];
      ...
      <Form className={styles.general_info_form}>
        ...
        <div className={styles.collection}>
          ...
          <div className={styles.field}>
            ...
            />
            <ErrorMessage name="foundedYear" component={InputErrorMessage} />
          </div>
        </div>

...
router.route("/profile/experience").post(
  // userValidator.addExperienceValidator,
...
// Education
router.route("/profile/education/level").patch(
  // userValidator.updateEducationLevelValidator,
  userController.updateEducationLevel
);
router.route("/profile/education").post(
  // userValidator.addEducationValidator,
  userController.addEducation
);
router
  .route("/profile/education/:id")
  .patch(
    // userValidator.updateEducationValidator,
...
// Certification
router.route("/profile/certification").post(
...
// Language
router.route("/profile/language").post(
  // userValidator.addLanguageValidator,
  userController.addLanguage
);
router
  .route("/profile/language/:id")
  .patch(
    // userValidator.updateLanguageValidator,
    userController.updateLanguage
  )
  .delete(
    // userValidator.deleteLanguageValidator,
